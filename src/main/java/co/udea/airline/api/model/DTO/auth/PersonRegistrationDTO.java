...
public class PersonRegistrationDTO {
     ...
     *
     @return the cc of the person.
      * @param cc The document number for the person.
     */
    @NotBlank(message = "CC (Cédula) is required")
    @Pattern(regexp = "^[0-9]{10}$", message = "CC must be 10 digits")
    private String cc;
    /**
     * -- GETTER --
     ...
     *
     * @param cc The identification number of the person.
     ...
     */
    public PersonRegistrationDTO(String cc, String idType, String firstname, String lastname, String mail, String password,
