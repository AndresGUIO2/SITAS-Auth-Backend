 ...
 * {@link co.udea.airline.api.utils.exception.PersonAlreadyExistsException},
 * are thrown by the service layer when specific error conditions are met, and are
 * handled globally by the {@link co.udea.airline.api.utils.exception.CExceptionHandler} class.</p>
 *
